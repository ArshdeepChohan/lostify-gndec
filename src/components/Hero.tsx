...
const Hero = () => {
  return (
    <section className="relative py-20 bg-gradient-to-b from-white to-gndec-gray/30 overflow-hidden">
      {/* Background decorations */}
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-[30%] -right-[10%] w-[500px] h-[500px] rounded-full bg-gndec-blue/5 blur-3xl" />
      ...
      <div className="container px-4 mx-auto">
        <div className="max-w-3xl mx-auto text-center">
          <div className="flex justify-center mb-6">
            <img src="https://gndec.ac.in/sites/default/files/logo.png" alt="GNDEC Logo" className="h-16" />
          </div>
          ...
          <div className="mt-8 flex items-center justify-center">
            <Link to="/image-search">
              <Button variant="ghost" className="text-gndec-blue gap-2 group">
                <Camera size={18} />
          ...
          <div className="mt-16 p-4 bg-white rounded-lg shadow-md border border-gndec-gray max-w-2xl mx-auto">
            ...
            <div className="flex justify-center">
              <Button variant="outline" className="text-gndec-blue border-gndec-blue hover:bg-gndec-blue/10 gap-2">
                <Search size={16} />
